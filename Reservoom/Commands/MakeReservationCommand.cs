...
namespace Reservoom.Commands
{
    public class MakeReservationCommand : CommandBase
    {
        ...
        {
            return !string.IsNullOrEmpty(_makeReservationViewModel.Username) && base.CanExecute(parameter) && _makeReservationViewModel.FloorNumber > 0 && _makeReservationViewModel.RoomNumber > 0;
        }
